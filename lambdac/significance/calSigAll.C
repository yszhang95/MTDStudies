...
void calSigAll()
{
   ...
   //TFile* f3 = new TFile("lamC3PMassHists_reRECO_all_smeared_ineff.root");
   //TFile* f3 = new TFile("lamC3PMassHists_reRECO_all_ineff.root");
   //TFile* f4 = new TFile("hyjetsMassHists_reRECO_all.root");
   TFile* f4 = new TFile("hyjetsMassHists_reRECO_woPID_200.root");
   TFile* f5 = new TFile("hyjetsMassHists_reRECO_wPID_4950.root");
   //TFile* f5 = new TFile("hyjetsMassHists_reRECO_all_hyjets_sample_wPID_nevts4950.list_smared_ineff.root");
   //TFile* f5 = new TFile("hyjetsMassHists_reRECO_all_hyjets_sample_wPID_nevts4950.list_ineff.root");
   ...
   f5->GetObject("hMassVsPtVsYMtd", hBkgMtd);
   //f3->GetObject("hMassVsPtVsYMtd_Smeared", hSignalMtd);
   //f5->GetObject("hMassVsPtVsYMtd_Smeared", hBkgMtd);
   //f3->GetObject("hMassVsPtVsYMtd_1layer", hSignalMtd);
   //f5->GetObject("hMassVsPtVsYMtd_1layer", hBkgMtd);
   //f3->GetObject("hMassVsPtVsYMtd_3halflayers", hSignalMtd);
   //f5->GetObject("hMassVsPtVsYMtd_3halflayers", hBkgMtd);
   //f3->GetObject("hMassVsPtVsYMtd_loose", hSignalMtd);
   //f5->GetObject("hMassVsPtVsYMtd_loose", hBkgMtd);
   ...
   //for(int ipt=0; ipt<2; ipt++){
      ...
      for(int iy=0; iy<ana::nuOfY; iy++){
         ...
         calSig(hSignalScale, hBkg, 
               ...
               sig, s, b, sErr, bErr);
         calSig_4751(hSignalMtdScale, hBkgMtd, 
               yCutMin, yCutMax, pTCutMin, pTCutMax, massCutMin, massCutMax, 
      ...
      ltx->DrawLatexNDC(0.35, 0.8, "MB 25B events");
      ltx->SetTextSize(0.035);
      ltx->DrawLatexNDC(0.55, 0.3, Form("%.1f #leq p_{T} < %.1f GeV", ana::ptbin[ipt], ana::ptbin[ipt+1]));
      c1->SaveAs(Form("LamCSigMBNew/sig_pT%.1f_%.1f.png", ana::ptbin[ipt], ana::ptbin[ipt+1]));
      c1->SaveAs(Form("LamCSigMBNew/sig_pT%.1f_%.1f.pdf", ana::ptbin[ipt], ana::ptbin[ipt+1]));
      ...
      ltx->SetTextSize(0.035);
      ltx->DrawLatexNDC(0.55, 0.3, Form("%.1f < p_{T} < %.1f GeV", ana::ptbin[ipt], ana::ptbin[ipt+1]));
      c2->SaveAs(Form("LamCSigMBNew/scaled_s_pT%.1f_%.1f.png", ana::ptbin[ipt], ana::ptbin[ipt+1]));
      c2->SaveAs(Form("LamCSigMBNew/scaled_s_pT%.1f_%.1f.pdf", ana::ptbin[ipt], ana::ptbin[ipt+1]));
      ...
      ltx->SetTextSize(0.035);
      ltx->DrawLatexNDC(0.55, 0.3, Form("%.1f #leq p_{T} < %.1f GeV", ana::ptbin[ipt], ana::ptbin[ipt+1]));
      c3->SaveAs(Form("LamCSigMBNew/scaled_b_pT%.1f_%.1f.png", ana::ptbin[ipt], ana::ptbin[ipt+1]));
      c3->SaveAs(Form("LamCSigMBNew/scaled_b_pT%.1f_%.1f.pdf", ana::ptbin[ipt], ana::ptbin[ipt+1]));
   }
}
