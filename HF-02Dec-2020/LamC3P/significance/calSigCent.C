...
void calSigCent()
{
   ...
   ana::calScalePerEvtCent(hGenPtMidY, hData, hScale, scale_factor_perEvt, ana::nmass, true);
   ...
   *hSignalMtdScale = (*hSignalMtd) * (*hScale);
   ...
   //for(int ipt=0; ipt<2; ipt++){
      ...
      c1->SaveAs(Form("LamCSigCMS0-10/sig_pT%.1f_%.1f.png", ana::ptbin[ipt], ana::ptbin[ipt+1]));
      ...
      ltx->SetTextSize(0.035);
      ltx->DrawLatexNDC(0.6, 0.3, Form("%.1f < p_{T} < %.1f GeV", ana::ptbin[ipt], ana::ptbin[ipt+1]));
      c2->SaveAs(Form("LamCSigCMS0-10/scaled_s_pT%.1f_%.1f.png", ana::ptbin[ipt], ana::ptbin[ipt+1]));
      ...
      ltx->SetTextSize(0.035);
      ltx->DrawLatexNDC(0.6, 0.3, Form("%.1f < p_{T} < %.1f GeV", ana::ptbin[ipt], ana::ptbin[ipt+1]));
      c3->SaveAs(Form("LamCSigCMS0-10/scaled_b_pT%.1f_%.1f.png", ana::ptbin[ipt], ana::ptbin[ipt+1]));
   }
}
