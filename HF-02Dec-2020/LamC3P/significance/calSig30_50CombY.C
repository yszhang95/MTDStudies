...
void calSig30_50CombY()
{
   ...
   f4->GetObject("hMassVsPtVsY30_50Mtd", hBkgMtd);
   ...
   //for(int ipt=0; ipt<2; ipt++){
      ...
      for(int iy=0; iy<ana::nuOfY; iy++){
         ...
         calSig30_50(hSignalScale, hBkg, 
               ...
               sig, s, b, sErr, bErr);
         calSig30_50(hSignalMtdScale, hBkgMtd, 
               yCutMin, yCutMax, pTCutMin, pTCutMax, massCutMin, massCutMax, 
...
/*
      ...
      c1->SaveAs(Form("LamCSigAlice30-50/sig_pT%.1f_%.1f.png", ana::ptbin[ipt], ana::ptbin[ipt+1]));
      ...
      ltx->SetTextSize(0.035);
      ltx->DrawLatexNDC(0.6, 0.3, Form("%.1f < p_{T} < %.1f GeV", ana::ptbin[ipt], ana::ptbin[ipt+1]));
      c2->SaveAs(Form("LamCSigAlice30-50/scaled_s_pT%.1f_%.1f.png", ana::ptbin[ipt], ana::ptbin[ipt+1]));
      ...
      ltx->SetTextSize(0.035);
      ltx->DrawLatexNDC(0.6, 0.3, Form("%.1f < p_{T} < %.1f GeV", ana::ptbin[ipt], ana::ptbin[ipt+1]));
      c3->SaveAs(Form("LamCSigAlice30-50/scaled_b_pT%.1f_%.1f.png", ana::ptbin[ipt], ana::ptbin[ipt+1]));
      */
   }
