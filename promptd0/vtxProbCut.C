...
void vtxProbCut()
{
   ...
   TH3F* hScale = new TH3F("hScale", "", ana::ny, ana::yMin, ana::yMax, ana::npt, ana::ptMin, ana::ptMax, ana::nVtxProb, ana::VtxProbMin, ana::VtxProbMax);
   for(int ipt=0; ipt<ana::npt; ipt++){
      ...
      for(int iy=0; iy<ana::ny; iy++){
         for(int iz=0; iz<ana::nVtxProb; iz++){
