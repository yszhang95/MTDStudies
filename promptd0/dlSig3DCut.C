...
void dlSig3DCut()
{
   ...
   TH3F* hScale = new TH3F("hScale", "", ana::ny, ana::yMin, ana::yMax, ana::npt, ana::ptMin, ana::ptMax, ana::ndlSig3D, ana::dlSig3DMin, ana::dlSig3DMax);
   for(int ipt=0; ipt<ana::npt; ipt++){
      ...
      for(int iy=0; iy<ana::ny; iy++){
         for(int iz=0; iz<ana::ndlSig3D; iz++){
