#!/usr/bin/env python
import ROOT as r
r.gROOT.LoadMacro('helpers3MeV.cc+')
Phi = r.Particle(333)
Phi.selfConj(True);
...
ts.Print()
r.genMatchFSDsMass('DsHydJets_pT0to3p05_y0p95to2p05.list', 'ds_ana_mc', Ds, topoCut, kinsCut, -1, False, False, False)
ts.Print()
r.genMatchFSDsMass('DsHydJets_pT0to3p05_y1p95to3p05.list', 'ds_ana_mc', Ds, topoCut, kinsCut, -1, False, False, False)
