...
void calSigAll()
{
   ...
   std::ofstream fSBwMB("SBMB.txt");
   std::ofstream fSBwoMB("SBMBWoMTD.txt");
   fSBwMB << "S0,SErr0,B0,BErr0,S1,SErr1,B1,BErr1,S2,SErr2,B2,BErr2" << endl;
   fSBwoMB << "S0,SErr0,B0,BErr0,S1,SErr1,B1,BErr1,S2,SErr2,B2,BErr2" << endl;
