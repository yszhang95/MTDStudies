...
config.JobType.psetName = 'PbPbSkimAndTreePhaseIIMTD_Ds_PhiPi_mc_DsAlpha0p5_pT0to3p05_y1p95to3p05_cfg.py'
...
for key, val in dataMap.items():
    config.General.requestName = 'PbPb5p5TeV_'+key+'_Ds_PhiPi_DsAlpha0p5_pT0to3p05_y1p95to3p05_20210326'
