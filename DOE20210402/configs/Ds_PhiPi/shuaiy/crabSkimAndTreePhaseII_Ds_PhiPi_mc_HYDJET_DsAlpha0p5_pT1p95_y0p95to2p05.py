...
config.JobType.psetName = 'PbPbSkimAndTreePhaseIIMTD_Ds3P_PhiPi_mc_DsAlpha0p6_pT1p95_y0p95to2p05.py'
...
for key, val in dataMap.items():
    config.General.requestName = 'PbPb5p5TeV_'+key+'_Ds_PhiPi_DsAlpha0p6_pT1p95_y0p95to2p05_20210328'
