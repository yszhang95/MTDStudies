...
void fillHyJetsMass(std::string list="", const bool inEff = true, const float res=0.035, const float nRMS=1.0, const bool disableETL=false,
    const bool forceDisable=true, const bool acceptFwdTrk=true)
{
